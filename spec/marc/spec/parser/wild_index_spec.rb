...
module MARC
  module Spec
    describe :wild_index do
      ...
      describe 'wild combination of valid field tag and invalid index (valid)' do
      ...
      describe 'wild combination of valid field tag and index (valid)' do
      ...
      describe 'wild combination of valid field tag and invalid index (invalid)' do
        it 'empty string (invalid)' do
          expect(parser.marc_spec).not_to parse('...[]', trace: true)
        end
        it 'whitespace is not allowed (invalid)' do
