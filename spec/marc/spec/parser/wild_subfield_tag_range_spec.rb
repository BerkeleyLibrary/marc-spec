...
module MARC
  module Spec
    describe :wild_subfield_tag_range do
      ...
      describe 'wild combination of valid field tag, subfield tag and subfield range (valid)' do
        it 'lowercase alpha subfieldtag a && subfield range with lowercase subfieldtags (valid)' do
          expect(parser.marc_spec).to parse('...$a$a-z', trace: true)
        end
        it 'lowercase alpha subfieldtag a && subfield range with digits (valid)' do
          expect(parser.marc_spec).to parse('...$a$0-9', trace: true)
        end
        it 'lowercase alpha subfieldtag z && subfield range with lowercase subfieldtags (valid)' do
          expect(parser.marc_spec).to parse('...$z$a-z', trace: true)
        end
        it 'lowercase alpha subfieldtag z && subfield range with digits (valid)' do
          expect(parser.marc_spec).to parse('...$z$0-9', trace: true)
        end
        it 'digit subfieldtag 0 && subfield range with lowercase subfieldtags (valid)' do
          expect(parser.marc_spec).to parse('...$0$a-z', trace: true)
        end
        it 'digit subfieldtag 0 && subfield range with digits (valid)' do
          expect(parser.marc_spec).to parse('...$0$0-9', trace: true)
        end
        it 'digit subfieldtag 9 && subfield range with lowercase subfieldtags (valid)' do
          expect(parser.marc_spec).to parse('...$9$a-z', trace: true)
        end
        it 'digit subfieldtag 9 && subfield range with digits (valid)' do
        ...
        it 'subfieldtag _ && subfield range with lowercase subfieldtags (valid)' do
          expect(parser.marc_spec).to parse('...$_$a-z', trace: true)
        end
        it 'subfieldtag _ && subfield range with digits (valid)' do
