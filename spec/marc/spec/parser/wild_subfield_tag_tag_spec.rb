...
module MARC
  module Spec
    describe :wild_subfield_tag_tag do
      let(:parser) { Parser.new }

      describe 'wild combination of valid field tag and subfield tags (valid)' do
        it 'lowercase alpha subfieldtag a && lowercase alpha subfieldtag a (valid)' do
          expect(parser.marc_spec).to parse('...$a$a', trace: true)
        end
        it 'lowercase alpha subfieldtag a && lowercase alpha subfieldtag z (valid)' do
          expect(parser.marc_spec).to parse('...$a$z', trace: true)
        end
        it 'lowercase alpha subfieldtag a && digit subfieldtag 0 (valid)' do
          expect(parser.marc_spec).to parse('...$a$0', trace: true)
        end
        it 'lowercase alpha subfieldtag a && digit subfieldtag 9 (valid)' do
          expect(parser.marc_spec).to parse('...$a$9', trace: true)
        end
        it 'lowercase alpha subfieldtag a && subfieldtag ! (valid)' do
        ...
        it 'lowercase alpha subfieldtag a && subfieldtag _ (valid)' do
        ...
        it 'lowercase alpha subfieldtag z && lowercase alpha subfieldtag a (valid)' do
          expect(parser.marc_spec).to parse('...$z$a', trace: true)
        end
        it 'lowercase alpha subfieldtag z && lowercase alpha subfieldtag z (valid)' do
          expect(parser.marc_spec).to parse('...$z$z', trace: true)
        end
        it 'lowercase alpha subfieldtag z && digit subfieldtag 0 (valid)' do
          expect(parser.marc_spec).to parse('...$z$0', trace: true)
        end
        it 'lowercase alpha subfieldtag z && digit subfieldtag 9 (valid)' do
          expect(parser.marc_spec).to parse('...$z$9', trace: true)
        end
        it 'lowercase alpha subfieldtag z && subfieldtag ! (valid)' do
        ...
        it 'lowercase alpha subfieldtag z && subfieldtag _ (valid)' do
        ...
        it 'digit subfieldtag 0 && lowercase alpha subfieldtag a (valid)' do
          expect(parser.marc_spec).to parse('...$0$a', trace: true)
        end
        it 'digit subfieldtag 0 && lowercase alpha subfieldtag z (valid)' do
          expect(parser.marc_spec).to parse('...$0$z', trace: true)
        end
        it 'digit subfieldtag 0 && digit subfieldtag 0 (valid)' do
          expect(parser.marc_spec).to parse('...$0$0', trace: true)
        end
        it 'digit subfieldtag 0 && digit subfieldtag 9 (valid)' do
          expect(parser.marc_spec).to parse('...$0$9', trace: true)
        end
        it 'digit subfieldtag 0 && subfieldtag ! (valid)' do
        ...
        it 'digit subfieldtag 0 && subfieldtag _ (valid)' do
        ...
        it 'digit subfieldtag 9 && lowercase alpha subfieldtag a (valid)' do
          expect(parser.marc_spec).to parse('...$9$a', trace: true)
        end
        it 'digit subfieldtag 9 && lowercase alpha subfieldtag z (valid)' do
          expect(parser.marc_spec).to parse('...$9$z', trace: true)
        end
        it 'digit subfieldtag 9 && digit subfieldtag 0 (valid)' do
          expect(parser.marc_spec).to parse('...$9$0', trace: true)
        end
        it 'digit subfieldtag 9 && digit subfieldtag 9 (valid)' do
          expect(parser.marc_spec).to parse('...$9$9', trace: true)
        end
        it 'digit subfieldtag 9 && subfieldtag ! (valid)' do
        ...
        it 'digit subfieldtag 9 && subfieldtag _ (valid)' do
        ...
        it 'subfieldtag _ && lowercase alpha subfieldtag a (valid)' do
          expect(parser.marc_spec).to parse('...$_$a', trace: true)
        end
        it 'subfieldtag _ && lowercase alpha subfieldtag z (valid)' do
          expect(parser.marc_spec).to parse('...$_$z', trace: true)
        end
        it 'subfieldtag _ && digit subfieldtag 0 (valid)' do
          expect(parser.marc_spec).to parse('...$_$0', trace: true)
        end
        it 'subfieldtag _ && digit subfieldtag 9 (valid)' do
          expect(parser.marc_spec).to parse('...$_$9', trace: true)
        end
        it 'subfieldtag _ && subfieldtag ! (valid)' do
          expect(parser.marc_spec).to parse('...$_$!', trace: true)
        end
        it 'subfieldtag _ && subfieldtag # (valid)' do
          expect(parser.marc_spec).to parse('...$_$#', trace: true)
        ...
        it 'subfieldtag _ && subfieldtag _ (valid)' do
